      ...
      <motion.section
        ...
        <ol className="mt-4 space-y-3 text-sm leading-relaxed text-white/60 sm:text-[15px]">
          <li className="flex gap-3">
            ...
            <span>
              <strong className="font-medium text-white/85">The 3D map</strong>{" "}
              is an interactive John Abbott College Library model (orbit, zoom,
              room picks). When you analyze a clip, the same homography overlay
              is shown on the{" "}
              <strong className="text-white/85">3D ground slab</strong>, using{" "}
              <code className="rounded bg-white/[0.08] px-1.5 py-0.5 text-[12px] text-white/70">
                /floorplans/floorplan_transparent.png
              </code>{" "}
              plus the API heat PNG. Extruded rooms are illustrative; the heat
              is aligned to the floor image footprint, not per-room geometry.
            </span>
          </li>
          <li className="flex gap-3">
            <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-white/[0.08] text-xs font-semibold text-white/80">
            ...
            <span>
              <strong className="font-medium text-white/85">Pick a clip</strong>{" "}
              (filename only on tiles; optional{" "}
              <strong className="text-white/85">Preview</strong> if you need to
              see pixels). That URL drives motion analysis — humans stay off the
              main map.
            </span>
          </li>
          <li className="flex gap-3">
            ...
            <span>
              ...
              ) returns a heat grid + zones in 0–100% space; we{" "}
              <strong className="text-white/85">
                draw them on the 2D schematic preview
              </strong>{" "}
              under the 3D view. For{" "}
              <strong className="text-white/85">IMG_5530.mp4</strong>, the API
              can{" "}
              <strong className="text-white/85">
                warp video motion into the corridor band
              </strong>{" "}
              on the PNG (tunable via{" "}
              <code className="rounded bg-white/[0.08] px-1.5 py-0.5 text-[12px] text-white/70">
